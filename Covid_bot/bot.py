"""
Это телеграм-бот, который может ссобщать статистику по коронавирусу. Данные собираются с помощью парсинга сайта
https://ncov.blog/countries/ru/ и хранятся в словаре (в формате
"название места: [название места, все заражения, все смерти, все выздоровления, летальность, новые случаи, новые смерти, новые выздоровления]").
Когда пользователь пишет название места, бот определяет, какой элемент словаря соотвествует такому ключу и отправляет данные.
С помощью if-elif он понимает, что США, например, - это то же, что Соединённые Штаты Америки, Республика Саха - то же, что Якутия и т.п.
"""
...
def get_text_messages(message):
    ...
    # break везде стоит для того, чтобы сообщение отправилось только 1 раз
    for key in stat:
        ...
        # Собственно, следующий код обрабатывает получение названий таких мест.
            ...
            bot_message = 'Заболели: ' + stat['россия'][1] + '\n' + 'Умерли: ' + stat['россия'][
                2] + '\n' + 'Вылечились: ' + stat['россия'][3] + '\n' + 'Летальность: ' + stat['россия'][
                              4] + '\n' + 'Новые случаи: ' + stat['россия'][5] + '\n' + 'Новые смерти: ' + \
                          stat['россия'][6] + '\n' + 'Новые выздоровления: ' + stat['россия'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
            ...
            bot_message = 'Заболели: ' + stat['соединенные штаты'][1] + '\n' + 'Умерли: ' + stat['соединенные штаты'][
                2] + '\n' + 'Вылечились: ' + stat['соединенные штаты'][3] + '\n' + 'Летальность: ' + \
                          stat['соединенные штаты'][4] + '\n' + 'Новые случаи: ' + stat['соединенные штаты'][
                              5] + '\n' + 'Новые смерти: ' + stat['соединенные штаты'][
                              6] + '\n' + 'Новые выздоровления: ' + stat['соединенные штаты'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        elif message.text.lower() == 'кнр' or message.text.lower() == 'китайская народная республика':
            bot_message = 'Заболели: ' + stat['китай'][1] + '\n' + 'Умерли: ' + stat['китай'][
                2] + '\n' + 'Вылечились: ' + stat['китай'][3] + '\n' + 'Летальность: ' + stat['китай'][
                              4] + '\n' + 'Новые случаи: ' + stat['китай'][5] + '\n' + 'Новые смерти: ' + stat['китай'][
                              6] + '\n' + 'Новые выздоровления: ' + stat['китай'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
            ...
            bot_message = 'Заболели: ' + stat['соединенное королевство'][1] + '\n' + 'Умерли: ' + \
                          stat['соединенное королевство'][2] + '\n' + 'Вылечились: ' + stat['соединенное королевство'][
                              3] + '\n' + 'Летальность: ' + stat['соединенное королевство'][
                              4] + '\n' + 'Новые случаи: ' + stat['соединенное королевство'][
                              5] + '\n' + 'Новые смерти: ' + stat['соединенное королевство'][
                              6] + '\n' + 'Новые выздоровления: ' + stat['соединенное королевство'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        elif message.text.lower() == 'якутия' or message.text.lower() == 'республика саха':
            bot_message = 'Заболели: ' + stat['республика саха (якутия)'][1] + '\n' + 'Умерли: ' + \
                          stat['республика саха (якутия)'][2] + '\n' + 'Вылечились: ' + \
                          stat['республика саха (якутия)'][3] + '\n' + 'Летальность: ' + \
                          stat['республика саха (якутия)'][4] + '\n' + 'Новые случаи: ' + \
                          stat['республика саха (якутия)'][5] + '\n' + 'Новые смерти: ' + \
                          stat['республика саха (якутия)'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['республика саха (якутия)'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
            ...
            bot_message = 'Заболели: ' + stat['республика северная осетия — алания'][1] + '\n' + 'Умерли: ' + \
                          stat['республика северная осетия — алания'][2] + '\n' + 'Вылечились: ' + \
                          stat['республика северная осетия — алания'][3] + '\n' + 'Летальность: ' + \
                          stat['республика северная осетия — алания'][4] + '\n' + 'Новые случаи: ' + \
                          stat['республика северная осетия — алания'][5] + '\n' + 'Новые смерти: ' + \
                          stat['республика северная осетия — алания'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['республика северная осетия — алания'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
            ...
            bot.send_message(message.from_user.id,
                             'Северная Корея официально не подтвердила ни одного случая заболевания коронавирусом')
            break
        elif message.text.lower() == 'еврейская ао':
            bot_message = 'Заболели: ' + stat['еврейская автономная область'][1] + '\n' + 'Умерли: ' + \
                          stat['еврейская автономная область'][2] + '\n' + 'Вылечились: ' + \
                          stat['еврейская автономная область'][3] + '\n' + 'Летальность: ' + \
                          stat['еврейская автономная область'][4] + '\n' + 'Новые случаи: ' + \
                          stat['еврейская автономная область'][5] + '\n' + 'Новые смерти: ' + \
                          stat['еврейская автономная область'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['еврейская автономная область'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        elif message.text.lower() == 'ненецкий ао':
            bot_message = 'Заболели: ' + stat['ненецкий автономный округ'][1] + '\n' + 'Умерли: ' + \
                          stat['ненецкий автономный округ'][2] + '\n' + 'Вылечились: ' + \
                          stat['ненецкий автономный округ'][3] + '\n' + 'Летальность: ' + \
                          stat['ненецкий автономный округ'][4] + '\n' + 'Новые случаи: ' + \
                          stat['ненецкий автономный округ'][5] + '\n' + 'Новые смерти: ' + \
                          stat['ненецкий автономный округ'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['ненецкий автономный округ'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        elif message.text.lower() == 'ханты-мансийский ао':
            bot_message = 'Заболели: ' + stat['ханты-мансийский автономный округ'][1] + '\n' + 'Умерли: ' + \
                          stat['ханты-мансийский автономный округ'][2] + '\n' + 'Вылечились: ' + \
                          stat['ханты-мансийский автономный округ'][3] + '\n' + 'Летальность: ' + \
                          stat['ханты-мансийский автономный округ'][4] + '\n' + 'Новые случаи: ' + \
                          stat['ханты-мансийский автономный округ'][5] + '\n' + 'Новые смерти: ' + \
                          stat['ханты-мансийский автономный округ'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['ханты-мансийский автономный округ'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        elif message.text.lower() == 'чукотский ао':
            bot_message = 'Заболели: ' + stat['чукотский автономный округ'][1] + '\n' + 'Умерли: ' + \
                          stat['чукотский автономный округ'][2] + '\n' + 'Вылечились: ' + \
                          stat['чукотский автономный округ'][3] + '\n' + 'Летальность: ' + \
                          stat['чукотский автономный округ'][4] + '\n' + 'Новые случаи: ' + \
                          stat['чукотский автономный округ'][5] + '\n' + 'Новые смерти: ' + \
                          stat['чукотский автономный округ'][6] + '\n' + 'Новые выздоровления: ' + \
                          stat['чукотский автономный округ'][
                              7] + '\n' + 'Источник:' + url + '\n' + '(А там данные с сайта стопкоронавирус.рф и Университета Джона Хопкинса)'
            bot.send_message(message.from_user.id, bot_message)
            break
        # Если пользователь не понял, почему бот не знает названия, которое он написал, он может попросить подсказку
        elif message.text == '/help':
            bot.send_message(message.from_user.id,
                             'Если в названии региона есть слово "республика", то надо его написать. Так же попробуйте написать "е" вместо "ё". Названия регионов со словом "республика" могут быть в форматах "n-ая республика" или "республика n". Можете попробовать поменять формат. Кроме того, я не знаю статистику по миру в целом.')
            break
        # Бот умеет здороваться с новым пользователем
        elif message.text == '/start':
            bot.send_message(message.from_user.id,
                             'Здравствуйте!')
            break
        # Если пользователь написал что-то непонятное, то бот скажет, что не понимает его
        else:
            bot.send_message(message.from_user.id,
                             'Извините, я Вас не понимаю. Если Вы уверены, что правильно написали название страны/региона, напишите /help')
            break
